...
public class JCheckBoxDemo1 extends JPanel implements ActionListener { 
	...
	groupe.add(b1); groupe.add(b2); groupe.add(b3);
	...
	frame.getContentPane().add(new JCheckBoxDemo1(), BorderLayout.CENTER); 
	frame.pack(); 
